...
using Roster.Backend.Core.ProjectAggregate;
using Roster.Backend.Core.Services;
using Roster.Backend.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace Roster.Backend.UnitTests.Core.Services
{
