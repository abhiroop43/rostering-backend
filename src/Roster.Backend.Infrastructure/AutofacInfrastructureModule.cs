...
using Roster.Backend.Infrastructure.Data;
using Roster.Backend.Infrastructure.Data.Queries;
using Roster.Backend.Infrastructure.Email;
using Roster.Backend.UseCases.Contributors.Create;
using Roster.Backend.UseCases.Contributors.List;
using MediatR;
using MediatR.Pipeline;
using Module = Autofac.Module;

namespace Roster.Backend.Infrastructure;
